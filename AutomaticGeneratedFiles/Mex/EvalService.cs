...
namespace EvalServiceLibrary2
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Eval", Namespace="http://schemas.datacontract.org/2004/07/EvalServiceLibrary2")]
...
public interface IEvalService
{
    ...
    void SubmitEval(EvalServiceLibrary2.Eval eval);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEvalService/SubmitEval", ReplyAction="http://tempuri.org/IEvalService/SubmitEvalResponse")]
    System.Threading.Tasks.Task SubmitEvalAsync(EvalServiceLibrary2.Eval eval);
    ...
    EvalServiceLibrary2.Eval[] GetEvals();
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEvalService/GetEvals", ReplyAction="http://tempuri.org/IEvalService/GetEvalsResponse")]
    System.Threading.Tasks.Task<EvalServiceLibrary2.Eval[]> GetEvalsAsync();
}
...
public partial class EvalServiceClient : System.ServiceModel.ClientBase<IEvalService>, IEvalService
{
    ...
    public void SubmitEval(EvalServiceLibrary2.Eval eval)
    {
        base.Channel.SubmitEval(eval);
    }
    
    public System.Threading.Tasks.Task SubmitEvalAsync(EvalServiceLibrary2.Eval eval)
    {
        return base.Channel.SubmitEvalAsync(eval);
    }
    
    public EvalServiceLibrary2.Eval[] GetEvals()
    {
        return base.Channel.GetEvals();
    }
    
    public System.Threading.Tasks.Task<EvalServiceLibrary2.Eval[]> GetEvalsAsync()
    {
